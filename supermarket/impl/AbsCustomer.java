...
import static week4.supermarket.util.ShoppingUtil.chooseCategory1;

public abstract class AbsCustomer implements Customer {
    private Category shouldBuy;
    private String custId;
    private double moneySpent;
    private int guangLeft = 0;//还剩几次可以逛的
    private int guangCount = 0;//guangLeft初始值

    public static final int DEFAULT_GUANG_COUNT = 5;//逛5个商品的种类
